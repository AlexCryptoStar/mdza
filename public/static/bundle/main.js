webpackJsonp([0], [, , function(e, t, n) {
    ...
    }, t.getAsset = m, t.getAssetsAsArray = v, t.isAssetRegisteredById = b, t.isAssetRegistered = function(e, t) {
    ...
    function g(e) {
        return b(e) && d.default.assets[e].hasOwnProperty("private_key")
    }

    function w(e) {
        return b(e) && d.default.assets[e].hasOwnProperty("seed")
    }
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        return {
            ...
            createSimpleTx: function(e) {
                return e.data = (0, s.getDataContractMethodCall)("transfer(address,uint256)", e.to_address, (0, r.bigNumber)(e.amount).times((0, r.bigNumber)(10).pow(v)).toString(16)), e.gas_limit = 13e4, e.to_address = p, e.amount = (0, r.bigNumber)(0), (0, s.createSimpleTx)(e)
            },
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        var t = (0, v.generateDefaultBackup)();
    ...
    function E(e) {
        try {
            ...
            if (void 0 !== t.v && void 0 !== t.network || (t = (0, v.generateDefaultBackup)({
                    assets: t
            ...
            var i = t.assets;
            for (var s in i)(0, v.isValidAsset)(i[s]) && (i[s] = (0, v.generateDefaultAsset)(i[s]));
            var d = (0, v.getTotalAssets)(i);
            if (d > 0) {
                var u = (0, r.collect)();
    ...
    function M() {
        (0, v.getAssetsAsArray)().forEach(function(e, t) {
            setTimeout(function() {
                return I((0, v.getAssetId)(e))
    ...
    function I(e) {
        ...
        if (void 0 !== t) {
            var n = l.Coins[t.symbol],
                r = (0, v.getAddresses)(e).map(function(e) {
    ...
    function N(e) {
        ...
        if (void 0 !== n) {
            ...
            return t.unshift((0, v.getAddresses)(e)), n.summary.fetching = !0, z(o.fetchTxs.apply(this, t)).then(function(e) {
                var t = (0, r.collect)();
    ...
    var L, B = t.fetchPrices = (L = void 0, function() {
        clearTimeout(L);
        var e = (0, v.getSymbolsFromAssets)();
    ...
    function D() {
        if (m.default.network === a.MAINNET && "function" == typeof ga && 8 === (0, p.locationHref)().indexOf("coinfy.com")) {
            ...
            e.unshift("send", "event"), ga.apply(this, e)
        }
    }
    B()
}, , function(e, t, n) {
    ...
    (function(Buffer) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            var n = t[e];
            if (void 0 !== n) return m = e, b = n.api_url, v = n.url, n.url_myetherapi, !0;
            return !1
        };
        var r = n(73);
        Object.defineProperty(t, "addHexPrefix", {
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                ...
                r = e[0];
            return (t > 0 && void 0 !== F[r] ? Promise.resolve(F[r]) : fetch(b + "?module=account&action=txlist&address=" + r + "&startblock=0&endblock=99999999&sort=desc&apikey=" + h).then(function(e) {
                return e.json()
            })).then(function(e) {
                F[r] = e;
            ...
            var t = e.gas_limit,
                ...
                r = e.use_cache,
                o = void 0 !== r && r;
            return void 0 !== A[x] && o ? Promise.resolve(A[x]) : fetch(b + "?module=proxy&action=eth_gasPrice&apikey=" + h).then(function(e) {
                return e.json()
            }).then(function(e) {
            ...
            var t = e.from_addresses,
                ...
                m = t[p],
                v = r[p];
            return fetch(b + "?module=proxy&action=eth_getTransactionCount&tag=latest&address=" + m + "&apikey=" + h).then(function(e) {
                return e.json()
            }).then(function(e) {
                var t = {
                ...
                return r.sign(Buffer.from(v, "hex")), (0, s.sanitizeHex)(r.serialize().toString("hex"))
            })
        ...
        function j(e, t) {
            ...
            return fetch(void 0 === t ? b + "?apikey=" + h + "&module=account&action=balance&address=" + e + "&tag=latest" : b + "?apikey=" + h + "&module=account&action=tokenbalance&address=" + e + "&contractaddress=" + t + "&tag=latest").then(function(e) {
                return e.json()
            }).then(function(e) {
        ...
        function M(e) {
            return fetch(b + "?module=proxy&action=eth_sendRawTransaction&hex=" + e + "&apikey=" + h).then(function(e) {
                return e.json()
            }).then(function(e) {
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        var n = t[e];
        if (void 0 !== n) return b = e, v = n.network, m = n.url, g = m + "/api", !0;
        return !1
    }, t.format = function(e) {
        ...
        return (0, l.decryptBIP38)(e, t, n, v.wif)
        ...
        return l = j(l) ? l : u, fetch(g + "/addrs/" + t.join(",") + "/utxo?noCache=1").then(function(e) {
            ...
            var u = (0, s.bigNumber)(0),
                ...
                f = new o.default.TransactionBuilder(v);
            ...
            return p.gt(0) && f.addOutput(l, k(p)), f.inputs.forEach(function(e, n) {
                try {
                    var a = F(e.address),
                        ...
                        l = o.default.ECPair.fromWIF(r[i], v);
        ...
        return D[b === c.MAINNET ? "mainnet" : "testnet"]
    }, t.sendRawTxInsight = W, t.sendRawTxBlockcypher = U;
    var o = f(n(89)),
        a = f(n(419)),
        i = n(59),
        l = n(46),
    ...
    function O(e) {
        var t = e.seed,
            ...
            u = e.segwit,
            f = void 0 === u || u;
        void 0 === l && (l = b === c.MAINNET ? f ? _.mainnetsegwit : _.mainnet : f ? _.testnetsegwit : _.testnet);
    ...
    function S(e) {
        ...
        return {
            address: o.default.address.fromOutputScript(i, v),
            private_key: e.toWIF()
        }
    }
    ...
    function R(e) {
        return o.default.ECPair.fromWIF(e, v).getAddress().toString()
    }

    function z(e) {
        var t = o.default.ECPair.fromWIF(e, v);
        return function(e) {
            var t = M(e),
                n = o.default.crypto.hash160(t),
                r = o.default.script.scriptHash.output.encode(n);
            return o.default.address.fromOutputScript(r, v)
    ...
    var D = {
        mainnet: [{
            ...
            send: U("https://api.blockcypher.com/v1/btc/main/txs/push")
        }, {
            name: "Bitpay.com",
            url: h[c.MAINNET].url + "/tx/send",
            send: W(g + "/tx/send")
        }],
        testnet: [{
            name: "BlockCypher",
            url: "https://live.blockcypher.com/btc-testnet/pushtx/",
            send: U("https://api.blockcypher.com/v1/btc/test3/txs/push")
        }, {
            name: "Trezor.io",
            url: h[c.TESTNET].url + "/tx/send",
            send: W(g + "/tx/send")
        }]
    };
    ...
    t.default = function(e) {
        ...
        return l.default.createElement(v, null, l.default.createElement(u.default, r({}, e, {
    ...
    function m(e) {
        for (var t, n = e.total, r = e.score, o = [], a = 1; a <= n; ++a) t = a <= r ? h[r] : null, o.push(l.default.createElement(b, {
            color: t
        }));
        return l.default.createElement("div", null, o)
    }
    var v = s.default.div(o),
        b = s.default.div(a, function(e) {
            return e.color || "#EEE"
        }),
        ...
        z = function(e) {
            ...
            return function(e, t) {
                ...
                value: function() {
                    var e = this,
                        t = (0, u.collect)();
                    b.default.view.step = R.typing, b.default.view.is_valid_input = !1, b.default.view.is_valid_seed = !0, b.default.view.seed_input = "", b.default.view.seed_input_error = "", b.default.view.seed_password = "", b.default.view.seed_repassword = "", b.default.view.discovering = !1, b.default.view.addresses = [], b.default.view.address_selected = 0, t.destroy(), this.observer = (0, u.createObserver)(function(t) {
                        return e.forceUpdate()
                    }), this.observer.observe(b.default.view), this.observer.observe(b.default.view.addresses, "length");
                ...
                key: "onUpdateSeed",
                value: function() {
                    var e = b.default.view.seed_input;
                    if (e.length > 0) {
                        var t = (0, u.collect)();
                        b.default.view.is_valid_seed = (0, m.validateSeed)(e) && e.trim().split(/\s+/g).length === f.recovery_phrase_words, (0, g.isAssetRegisteredBySeed)(this.Coin.symbol, e) ? (b.default.view.seed_input_error = "You already have this asset", b.default.view.is_valid_input = !1) : (b.default.view.seed_input_error = "", b.default.view.is_valid_input = !0), t.emit()
                    }
                }
            }, {
                key: "onChangeInput",
                value: function(e) {
                    ...
                    b.default.view.seed_input = n, this.already_blur && this.onUpdateSeed(), t.emit()
                }
            }, {
                key: "onBlurInput",
                value: function(e) {
                    !this.already_blur && b.default.view.seed_input.length > 0 && (this.already_blur = !0, this.onUpdateSeed())
                }
            }, {
                key: "onChangePassword",
                value: function(e) {
                    b.default.view.seed_password = e.target.value
                }
            }, {
                key: "onChangeRepassword",
                value: function(e) {
                    b.default.view.seed_repassword = e.target.value
                }
            }, {
                key: "onNext",
                value: function(e) {
                    e.preventDefault();
                    var t = b.default.view.seed_input,
                        n = (0, u.collect)();
                    b.default.view.step = R.addresses, this.discoverWallet(t), n.emit()
                }
            }, {
                key: "discoverWallet",
                value: function(e) {
                    var t = this,
                        n = (0, u.collect)(),
                        r = b.default.view.addresses;
                    b.default.view.discovering = !0, this.Coin.discoverWallet({
                        seed: e
                    }, function(e) {
                        r === b.default.view.addresses && b.default.view.addresses.push(e)
                    }).then(function(n) {
                        r === b.default.view.addresses && (t.wallet = n, t.wallet.seed = e, b.default.view.discovering = !1)
                    }), n.emit()
                }
            }, {
                key: "onLoadMore",
                value: function() {
                    var e = this;
                    b.default.view.discovering = !0, this.Coin.discoverAddress(this.wallet).then(function(t) {
                        var n = (0, u.collect)();
                        e.wallet.index += 1, b.default.view.discovering = !1, b.default.view.addresses.push(t), n.emit()
                    })
                }
            }, {
                key: "onBack",
                value: function(e) {
                    e.preventDefault();
                    var t = (0, u.collect)();
                    b.default.view.addresses = [], b.default.view.step = R.typing, t.emit()
                }
            }, {
                key: "onChangeSelected",
                value: function(e) {
                    b.default.view.address_selected = e
                }
            }, {
                key: "onSubmit",
                value: function(e) {
                    e.preventDefault();
                    var t = (0, u.collect)(),
                        n = b.default.view.seed_input,
                        r = this.Coin.symbol,
                        o = this.Coin.multiaddress ? this.wallet.address : b.default.view.addresses[b.default.view.address_selected].address,
                        a = b.default.view.addresses.map(function(e) {
                            return e.address
                        }),
                        i = (0, v.createAsset)(this.Coin.type, r, o, a),
                        l = (0, g.getAssetId)(i);
                    (0, v.setSeed)(l, n, b.default.view.seed_password), (0, v.setHref)(w.routes.asset({
                        asset_id: l
                    })), (0, v.addNotification)('New "' + r + '" asset has been imported'), t.emit()
                }
            }, {
                key: "render",
                value: function() {
                    var e = b.default.view.addresses.reduce(function(e, t) {
                        return e.add(t.balance)
                    }, (0, p.bigNumber)(0));
                    return s.default.createElement(M, {
                        Coin: this.Coin,
                        step: b.default.view.step,
                        seed_input: b.default.view.seed_input,
                        seed_input_error: b.default.view.seed_input_error,
                        seed_password: b.default.view.seed_password,
                        seed_repassword: b.default.view.seed_repassword,
                        discovering: b.default.view.discovering,
                        addresses: b.default.view.addresses,
                        address_selected: b.default.view.address_selected,
                        total: e,
                        is_valid_seed: b.default.view.is_valid_seed,
                ...
                get: function() {
                    return b.default.view.seed_password.length > 0 && b.default.view.seed_repassword.length > 0 && b.default.view.seed_password.length === b.default.view.seed_repassword.length && b.default.view.seed_password !== b.default.view.seed_repassword
                }
            }, {
                key: "isValidForm",
                get: function() {
                    return b.default.view.is_valid_input && b.default.view.seed_input.length > 0 && b.default.view.seed_password.length >= f.minpassword && b.default.view.seed_password === b.default.view.seed_repassword
                }
            }]), t
        }();
    ...
    function T(e) {
        var t = e.components,
            ...
            h = r ? null : s.default.createElement(j, null, s.default.createElement(v.default, {
                position: "center",
                width: 175
            }, "No Private Key or Recovery Phrase"));
        o || s.default.createElement(j, null, s.default.createElement(v.default, {
            position: "center",
            width: 175
        }, "Only for assets created with Recovery Phrase"));
        return s.default.createElement(w.RightContainerPadding, null, s.default.createElement(x.default, null), s.default.createElement(w.RightContent, null, s.default.createElement(b.default, {
        ...
        s.default.createElement(y.MenuContentItemText, null, "Buy")), s.default.createElement(y.MenuContentItem, {
            disabled: !r,
            selected: n === f.routes.assetSend,
            onClick: function(e) {
                r && a(f.routes.assetSend)
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        return (0, s.decryptBIP38)(e, t, n, v.wif)
        ...
        return l = P(l) ? l : s, fetch(g + "/addrs/" + t.join(",") + "/utxo?noCache=1").then(function(e) {
            ...
            var s = (0, d.bigNumber)(0),
                ...
                f = new i.default.TransactionBuilder(v);
            ...
            return p.gt(0) && f.addOutput(l, E(p)), f.inputs.forEach(function(e, n) {
                try {
                    var o = (e.address, !1),
                        ...
                        l = i.default.ECPair.fromWIF(r[a], v);
        ...
        return I[b === f.MAINNET ? "mainnet" : "testnet"]
    };
    var o, a = n(89),
        i = (o = a) && o.__esModule ? o : {
            default: o
    ...
    function C(e) {
        var t = e.seed,
            ...
            s = e.passphase,
            d = void 0 === s ? "" : s;
        void 0 === i && (i = b === f.MAINNET ? _.mainnet : _.testnet);
    ...
    function j(e) {
        return i.default.ECPair.fromWIF(e, v).getAddress().toString()
    }

    function F(e) {
        var t = i.default.ECPair.fromWIF(e, v);
        return function(e) {
            var t = A(e),
                n = i.default.crypto.hash160(t),
                r = i.default.script.scriptHash.output.encode(n);
            return i.default.address.fromOutputScript(r, v)
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        return B[b === f.MAINNET ? "mainnet" : "testnet"]
    };
    var o, a = n(89),
        i = (o = a) && o.__esModule ? o : {
            default: o
    ...
    function O(e) {
        var t = e.seed,
            ...
            u = e.segwit,
            c = void 0 === u || u;
        void 0 === i && (i = b === f.MAINNET ? c ? _.mainnetsegwit : _.mainnet : c ? _.testnetsegwit : _.testnet);
    ...
    function S(e) {
        ...
        return {
            address: i.default.address.fromOutputScript(a, v),
            private_key: e.toWIF()
        }
    }
    ...
    var B = {
        mainnet: [{
            ...
            name: "Trezor.io",
            url: h[f.MAINNET].url + "/tx/send",
            send: (0, c.sendRawTxInsight)(g + "/tx/send")
        }],
        testnet: [{
            name: "Litecore.io",
            url: h[f.TESTNET].url + "/tx/send",
    ...
    function _(e) {
        ...
        return a.default.createElement("div", null, a.default.createElement(w.FormField, null, a.default.createElement(w.FormFieldLeft, null, a.default.createElement(g.Label, null, "Type"), a.default.createElement(g.SubLabel, null, "Regular or Segwit.")), a.default.createElement(w.FormFieldRight, null, a.default.createElement(h.default, {
        ...
        }))), a.default.createElement(w.FormField, null, a.default.createElement(w.FormFieldLeft, null, a.default.createElement(g.Label, null, "Password"), a.default.createElement(b.default, null, "Make sure that you remember this. This password can't be restored because we don't store it. For security reasons you will be asked often for this password."), a.default.createElement(g.SubLabel, null, "This password encrypts your private key.")), a.default.createElement(w.FormFieldRight, null, a.default.createElement(m.default, {
            minlength: f.minpassword,
            value: o,
            onChange: c,
            width: "100%",
            ...
            width: "100%",
            type: "password"
        }))), a.default.createElement(w.FormField, null, a.default.createElement(w.FormFieldButtons, null, a.default.createElement(v.default, {
            width: "100px",
            disabled: !l,
            onClick: x
        }, "Import"))))
    ...
    function x(e) {
        var t = e.type_segwit,
            ...
            y = e.onSubmit;
        return a.default.createElement("div", null, a.default.createElement(g.FormField, null, a.default.createElement(g.FormFieldLeft, null, a.default.createElement(b.Label, null, "Type"), a.default.createElement(b.SubLabel, null, "Regular or Segwit.")), a.default.createElement(g.FormFieldRight, null, a.default.createElement(m.default, {
            width: "100%",
            onChange: d
        }, a.default.createElement("option", {
            value: "false",
            ...
            value: "true",
            selected: t
        }, "Segwit")))), a.default.createElement(g.FormField, null, a.default.createElement(g.FormFieldLeft, null, a.default.createElement(b.Label, null, "Private key BIP38"), a.default.createElement(b.SubLabel, null, "Type or paste your private key in BIP38 format.")), a.default.createElement(g.FormFieldRight, null, a.default.createElement(h.default, {
            type: "text",
            width: "100%",
            value: n,
            onChange: u,
            error: r,
            invalid: r && n.length > 0
        }))), a.default.createElement(g.FormField, null, a.default.createElement(g.FormFieldLeft, null, a.default.createElement(b.Label, null, "Password"), a.default.createElement(b.SubLabel, null, "The password you used to encrypt this private key.")), a.default.createElement(g.FormFieldRight, null, a.default.createElement(h.default, {
            error: i,
            invalid: i,
            value: o,
            onChange: w,
            width: "100%",
            type: "password"
        }))), a.default.createElement(g.FormField, null, a.default.createElement(g.FormFieldButtons, null, a.default.createElement(v.default, {
            width: "100px",
            disabled: !s,
            loading: l,
            loadingIco: "/static/image/loading.gif",
    ...
    (function(Buffer) {
        ...
        var t = n(131),
            ...
            h = function(e) {
                for (var n = function(e) {
                        if (! function(e) {
                                try {
                                    return !!e && t.validateMnemonic(e)
                                } catch (e) {
                                    return !1
                                }
                            }(e)) {
                            var n = new Error("Invalid or unsupported mnemonic format");
                            throw n.name = "InvalidArgumentException", n
                        }
                        var a = Buffer.from(t.mnemonicToEntropy(e), "hex");
                        return o.encode((i = a, Buffer.from(r.blake2b(o.encode(i), null, 32))));
                        var i
                    }(e), l = void 0, s = 1; void 0 === l && s <= 1e3; s++) {
                    var d = a.createHmac("sha512", n);
                    d.update("Root Seed Chain " + s);
                    var u = d.digest("hex"),
                        c = Buffer.from(u.substr(0, 64), "hex");
                    try {
                        var f = v(c),
                            p = Buffer.from(i.keyFromSecret(c.toString("hex")).getPublic("hex"), "hex"),
                            h = Buffer.from(u.substr(64, 64), "hex");
                        l = new b({
                            secretKey: f,
                            publicKey: p,
                            chainCode: h
                        ...
                        if ("InvalidArgumentException" === m.name) continue;
                        throw m
                    }
                }
                if (void 0 === l) {
                    var m = new Error("Secret key generation from mnemonic is looping forever");
                    throw m.name = "RuntimeException", m
                }
                return l
            }("category age design kid snow ketchup give upper toe destroy various concert"),
            m = "DdzFFzCqrht9rXNV1cKD8gmVpi1WZa3cGGrm5i5S3XWaiWs8jMR8kMZwx395J5zLYmrE4HnRRQhdAYEUmP5YXvGPYJKWB18uvfsCSiqa";

        function v(e) {
            var t = a.createHash("sha512");
            t.update(e);
            var n = Buffer.from(t.digest("hex"), "hex");
            if (n[0] &= 248, n[31] &= 127, n[31] |= 64, 32 & n[31]) {
                var r = new Error("Invalid secret");
        ...
        function b(e) {
            var t = e.secretKey,
                ...
                r = e.chainCode,
                o = e.hdNodeString;
            o ? (this.secretKey = Buffer.from(o.substr(0, 128), "hex"), this.publicKey = Buffer.from(o.substr(128, 64), "hex"), this.chainCode = Buffer.from(o.substr(192, 64), "hex")) : (this.secretKey = t, this.publicKey = n, this.chainCode = r), this.extendedPublicKey = Buffer.concat([this.publicKey, this.chainCode], 64), this.getSecretKey = function() {
        ...
        async function g(e, t) {
            var n = void 0,
                a = void 0,
                i = void 0;
            if (t === p) n = Buffer.from([]), a = new Map, i = e;
            else {
                var d = await async function(e) {
                    return await async function(e, t, n, r, o) {
                        return await new Promise(function(a, i) {
                            l(e, t, n, r, o, function(e, t) {
                                e && i(e), a(t)
                            })
                        })
                    }(e.getExtendedPublicKey(), "address-hashing", 500, 32, "sha512")
                }(e);
                n = function(e, t) {
                    var n = o.encode(new w(e)),
                        r = new s.ChaCha20Poly1305(t);
                    return Buffer.from(r.seal(Buffer.from("serokellfore"), n))
                }([p, t], d), a = new Map([
                    [1, o.encode(n)]
                ]), i = function(e, t) {
                    var n = y(e, p);
                    if (t === p) throw new Error("Do not use deriveHdNode to derive root node");
                    return y(n, t)
                }(e, t)
            }
            var f = [function(e, t) {
                    return n = [0, [0, e.getExtendedPublicKey()], t.length > 0 ? new Map([
                        [1, o.encode(t)]
                    ]) : new Map], a = o.encode(n), i = Buffer.from(u.sha3_256(a), "hex"), Buffer.from(r.blake2b(i, null, 28));
                    var n, a, i
                }(i, n), a, 0],
                h = o.encode(f);
            return {
                address: c.encode(o.encode([new o.Tagged(24, h), E(h)])),
                childIndex: t,
                hdNode: i
            }
        }!async function() {
            for (var e = void 0, t = 21474e5; t < 2147499999; t++) e = await g(h, t), m === e.address && console.log(e.address)
        }();
        var w = function() {
            function t(e) {
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, t), this.elements = e
            }
            return e(t, [{
                key: "encodeCBOR",
                value: function(e) {
                    return e.push(Buffer.concat([Buffer.from([159])].concat(function(e) {
                        if (Array.isArray(e)) {
        ...
        function y(e, t) {
            var n = e.getChainCode(),
                r = a.createHmac("sha512", n);
            x(t) ? (r.update(Buffer.from([0])), r.update(e.getSecretKey())) : (r.update(Buffer.from([2])), r.update(e.getPublicKey())), r.update(Buffer.from(t.toString(16).padStart(8, "0"), "hex"));
            var o, l, s, u = Buffer.from(r.digest("hex"), "hex"),
                c = function(e) {
                    for (var t = "", n = 0, r = 0; r < e.length; r++) t += ((8 * e[r] & 255) + (8 & n) & 255).toString(16).padStart(2, "0"), n = 32 * e[r];
                    return Buffer.from(t, "hex")
                }(u, Buffer.from([8])).slice(0, 32),
                f = e.getSecretKey(),
                p = (o = c, l = f.slice(0, 32), s = _(s = d(_(o.toString("hex")), 16).plus(d(_(l.toString("hex")), 16)).mod(d("1000000000000000000000000000000014def9dea2f79cd65812631a5cf5d3ed", 16)).toString(16)).padEnd(64, "0"), Buffer.from(s, "hex")),
                h = function(e, t) {
                    for (var n = "", r = 0; r < 32; r++) n += (e[r] + t[r] & 255).toString(16).padStart(2, "0");
                    return Buffer.from(n, "hex")
                }(u.slice(32, 64), f.slice(32, 64)),
                m = Buffer.concat([p, h]),
                v = a.createHmac("sha512", n);
            x(t) ? (v.update(Buffer.from([1])), v.update(e.getSecretKey())) : (v.update(Buffer.from([3])), v.update(e.getPublicKey())), v.update(Buffer.from(t.toString(16).padStart(8, "0"), "hex"));
            var g = Buffer.from(v.digest("hex").slice(64, 128), "hex");
            return new b({
                secretKey: m,
                publicKey: Buffer.from(i.keyFromSecret(m.toString("hex").slice(0, 64)).getPublic("hex"), "hex"),
                chainCode: g
            })
        }
    ...
    var m = d.default.div(a, u.default.color.background1, function(e) {
        ...
        v = d.default.div(i, u.default.color.front3),
        b = d.default.div(l, function(e) {
            return e.open ? u.default.color.background3 : u.default.color.background5
    ...
    function x(e) {
        var t = e.private_input,
            ...
            c = e.onSubmit;
        return a.default.createElement("div", null, a.default.createElement(g.FormField, null, a.default.createElement(g.FormFieldLeft, null, a.default.createElement(b.Label, null, "Private key"), a.default.createElement(b.SubLabel, null, "Type or paste your private key.")), a.default.createElement(g.FormFieldRight, null, a.default.createElement(p.default, {
            width: "100%",
            value: t,
            onChange: s,
            error: n,
            invalid: n && t.length > 0
        }))), a.default.createElement(g.FormField, null, a.default.createElement(g.FormFieldLeft, null, a.default.createElement(b.Label, null, "Password"), a.default.createElement(v.default, null, "Make sure that you remember this. This password can't be restored because we don't store it. For security reasons you will be asked often for this password."), a.default.createElement(b.SubLabel, null, "This password encrypts your private key.")), a.default.createElement(g.FormFieldRight, null, a.default.createElement(h.default, {
            minlength: f.minpassword,
            value: r,
            onChange: d,
            width: "100%",
            type: "password"
        }))), a.default.createElement(g.FormField, null, a.default.createElement(g.FormFieldLeft, null, a.default.createElement(b.Label, null, "Repeat Password")), a.default.createElement(g.FormFieldRight, null, a.default.createElement(p.default, {
            minlength: f.minpassword,
            error: "Passwords do not match",
            invalid: l,
            value: o,
    ...
    var P = function(e) {
        ...
        return function(e, t) {
            ...
            value: function() {
                ...
                var n = (0, v.getParamsFromLocation)().symbol;
                ...
                n && (0, f.readFile)(n, function(e) {
                    ...
                    try {
                        var r = (0, p.keysToLowerCase)(e),
                            o = (0, b.formatAddress)(r.address);
                        3 === r.version && (0, b.isAddress)(o) && "object" == a(r.crypto) ? (0, v.isAssetRegistered)(t.Coin.symbol, o) ? m.default.view.keystore_invalid_error = "You already have this asset" : (t.keystore = r, m.default.view.address = o, m.default.view.keystore_invalid_error = "") : m.default.view.keystore_invalid_error = "Invalid Keystore file"
                    } catch (e) {
    ...
    function V(e) {
        ...
        return x.default.createElement(B.default, {
        ...
        }, x.default.createElement(W.default, {
            active: t
            ...
            color: "#000",
            "font-weight": "bold"
        }, v), x.default.createElement(O.Show, {
            if: s !== d
            ...
            color: C.default.color.background3
        }, b, " ", s)))), x.default.createElement(R.default, {
            "padding-top": "10px",
            clear: "both"
            ...
            }, x.default.createElement($, null, x.default.createElement(U.default, {
                checked: t === T
        ...
        }, x.default.createElement(oe, null, A), "" === re ? null : x.default.createElement(K.Label, {
            size: "11px"
    ...
    var ae = _.default.div(p, C.default.color.background4, C.default.color.grey1),
        ...
        le = _.default.div(m),
        se = _.default.div(v, function(e) {
            return e.color || C.default.color.grey1
        }),
        de = _.default.div(b, function(e) {
            ...
            return function(e, t) {
                ...
                value: function(e) {
                    ...
                    if (t === k.seed) {
                        ...
                        if (h) {
                            var v = (0, d.getPublicFromPrivateKey)(h),
                                b = [{
                            ...
                            (0, u.printTemplate)((0, _.PrivateKey)(b))
    ...
    function O(e) {
        var t = e.type_export,
            ...
            s = e.onExport;
        return a.default.createElement(v.default, null, a.default.createElement("form", null, a.default.createElement(y.FormField, null, a.default.createElement(y.FormFieldLeft, null, a.default.createElement(x.Label, null, "Format"), a.default.createElement(h.Show, {
            if: t === k.keystore
            ...
            error: "Invalid password",
            invalid: o
        })))), a.default.createElement(y.FormField, null, a.default.createElement(y.FormFieldButtons, null, a.default.createElement(b.default, {
            onClick: s
    ...
    var r, o, a = (r = ["\n    height: 100%;\n    background: linear-gradient(to bottom, #0071966e 150px, #d7dbd5 150px);\n"], o = ["\n    height: 100%;\n    background: linear-gradient(to bottom, #007196 150px, #d7dbd5 150px);\n"], Object.freeze(Object.defineProperties(r, {
        raw: {
            value: Object.freeze(o)
        }
    })));
    ...
    }, o.resolve = a, e.exports = o, o.id = 239
    ...
    o.keys = function() {
        return Object.keys(r)
    }, o.resolve = a, e.exports = o, o.id = 420
}, , , , , , , , , function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    t.PopupManager = function(e) {
        ...
        return b(t, d.default.Component), r(t, [{
            key: "onKeyDown",
            value: function(e) {
                e = e || window.event;
    ...
    var g = u.default.div(o, function(e) {
        ...
        w = (t.Popup = function(e) {
            function t(e) {
                return m(this, t), v(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e))
            }
            return b(t, d.default.Component), r(t, [{
    ...
    function v(e) {
        ...
        }), s.default.createElement(b, null, r)
    }
    t.default = m;
    var b = c.default.div(i)
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    function F(e) {
        ...
        return m.default.createElement(R, null, m.default.createElement(w.Show, {
            ...
            src: "/static/image/logo-full-blue-300x143.png",
            width: "80"
        }))), m.default.createElement(L, null, m.default.createElement(B, {
            visible: o
        }, m.default.createElement(W, null, m.default.createElement("span", null, "!"))), m.default.createElement(P.Dropdown, {
            onOpen: i,
            onClose: l,
            open: r
            ...
            visible: o
        }, m.default.createElement(W, null, m.default.createElement("span", null, "!")))), m.default.createElement(P.DropdownItem, {
            onClick: c
        }, "Settings"))))))
    }
    t.default = j;
    var A = v.default.div(o, g.default.infoColor.red),
        R = v.default.div(a, g.default.headerHeight, g.default.paddingOut, g.default.media.second, g.default.paddingOutMobile),
        z = v.default.div(i),
        M = v.default.div(l, g.default.media.first),
        I = v.default.div(s),
        N = v.default.div(d, function(e) {
            return e.isHome ? 1 : 0
        }),
        L = v.default.div(u),
        B = v.default.div(c, function(e) {
            return e.visible ? "block" : "none"
        }),
        D = v.default.div(f, function(e) {
            return e.visible ? "block" : "none"
        }),
        W = v.default.div(p)
}, , , function(e, t, n) {
    ...
    function T(e) {
        ...
        }, "Add Asset"))), m.default.createElement(F, {
            open: t,
            onClick: n
        }))
    }
    t.default = S;
    var j = b.default.div(o),
        F = b.default.div(a, w.default.media.first, function(e) {
            return e.open ? "auto" : "none"
        }, function(e) {
            return e.open ? .35 : 0
        }),
        A = b.default.div(i, w.default.paddingOut, w.default.headerHeight, w.default.leftColumn, w.default.paddingOut, w.default.headerHeight, w.default.media.first, function(e) {
            return e.open ? .2 : 0
        }, w.default.leftColumnMobile, function(e) {
            return e.open ? 0 : "-" + w.default.leftColumnMobile
        }),
        R = b.default.div(l, w.default.media.first),
        z = b.default.div(s),
        M = b.default.span(d, w.default.color.black),
        I = b.default.span(u, w.default.color.black),
        N = b.default.div(c, w.default.color.grey1),
        L = b.default.div(f, w.default.color.background4, w.default.media.first),
        B = b.default.div(p)
}, , function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        ...
        return function(e, t) {
            ...
            value: function() {
                (0, m.setHref)(p.routes.asset({
                    asset_id: (0, v.getAssetId)(this.props.asset)
                }))
            }
        }, {
            key: "render",
            value: function() {
                ...
                return s.default.createElement(y, {
                    ...
                    balance_currency: (0, v.formatCurrency)((0, v.convertBalance)(e.symbol, e.balance)),
                    logo: n.logo,
    ...
    function y(e) {
        ...
        return s.default.createElement(x, {
            onClick: i,
            selected: n === (0, v.getAssetId)(t)
        }, s.default.createElement(b.default, {
            logo: a,
            label: (0, v.getLabelOrAddress)(t),
    ...
    var M = function(e) {
        ...
        return function(e, t) {
            ...
            key: "render",
            value: function() {
                var e = (0, v.getParamsFromLocation)(),
                    t = e.asset_id,
                    n = e.symbol;
                if (t && !n) {
                    var r = (0, v.getAsset)(t);
                    r && (n = r.symbol)
                }
                return s.default.createElement(I, {
                    totalAssets: m.default.totalAssets,
                    isRegistered: (0, v.isAssetRegisteredById)(t),
                    symbol: n
                })
            }
        }]), t
    ...
    function I(e) {
        ...
        return s.default.createElement(N, null, s.default.createElement(b.RightContainer, null, s.default.createElement(f.Router, null, s.default.createElement(f.Route, {
            is: f.routes.home,
            if: 0 === t
        }, s.default.createElement(b.RightContainerMiddle, null, s.default.createElement(g.default, null, "Add or Import assets to start working"))), s.default.createElement(f.Route, {
            is: f.routes.home
            ...
            "path-0": "asset",
            if: n
        }, s.default.createElement(A.default, null)), s.default.createElement(f.Route, null, s.default.createElement(b.RightContainerMiddle, null, s.default.createElement(g.default, null, "Not found"))))))
    }
    t.default = M;
    ...
    var ie = function(e) {
        ...
        return function(e, t) {
            ...
            value: function() {
                ...
                return this.balance_start = Z.default.balance, K.default.createElement(le, {
                    data: i,
                    onClick: this.onClick,
    ...
    function le(e) {
        var t = e.data,
            ...
            l = 0;
        return K.default.createElement(ne.RightContainerPadding, null, K.default.createElement(se, null, K.default.createElement(ue, null, K.default.createElement(fe, null, K.default.createElement(pe, null, "Total balance"), K.default.createElement(he, null, K.default.createElement(me, null, r), K.default.createElement(ve, null, K.default.createElement(Y.default, {
            start: o,
            end: a,
            duration: 5,
            useEasing: !0,
            useGrouping: !0,
            separator: ","
        })))), K.default.createElement(ce, null, K.default.createElement(re.default, {
            size: 200,
            strokeWidth: "1.5",
        ...
        }))), K.default.createElement(We, null, t.map(function(e) {
            return K.default.createElement(Ue, null, K.default.createElement(Ke, null, K.default.createElement("img", {
                src: q.Coins[e.symbol].logo,
                width: "25",
                height: "25"
            })), K.default.createElement(He, null, K.default.createElement(Ge, null, q.Coins[e.symbol].name), K.default.createElement(Ye, null, e.symbol, " ≈", " ", K.default.createElement("span", null, J.Fiats[i].format(e.price, q.Coins[e.symbol].price_decimals)))))
        }))), K.default.createElement(de, null, K.default.createElement("div", null, t.map(function(e) {
            return K.default.createElement(be, null, K.default.createElement(ge, null, K.default.createElement(we, null, K.default.createElement(ye, null, K.default.createElement(re.default, {
                size: 43,
                strokeWidth: "2.5",
                segments: [{
            ...
            }, K.default.createElement(Pe, null, K.default.createElement("text", {
                x: "50%",
                y: "50%",
                class: "chart-number"
            }, e.percentage, "%")))), K.default.createElement(xe, null, K.default.createElement(_e, null, e.label), K.default.createElement(Ee, null, 1 === e.assets.length ? e.assets.length + " asset" : e.assets.length + " assets"))), K.default.createElement(ke, null, K.default.createElement(Ce, null, e.balance_currency), K.default.createElement(Oe, null, e.balance_asset))), K.default.createElement(Se, null, e.assets.map(function(t) {
                return K.default.createElement(Te, {
                    onClick: function() {
                        return n(t.id)
                    }
                }, K.default.createElement(je, null, K.default.createElement("img", {
                    src: t.logo,
                    width: "20",
                    height: "20"
                })), K.default.createElement(Fe, null, K.default.createElement(Ae, null, K.default.createElement(ze, null, t.label), K.default.createElement(Ie, null, t.address)), K.default.createElement(Re, null, K.default.createElement(Me, null, t.balance_currency), K.default.createElement(Ne, null, t.balance_asset)), K.default.createElement(Le, null, K.default.createElement(Be, {
                    percentage: t.percentage,
                    color: e.color
                }), K.default.createElement(De, {
                    color: e.color
                }, t.percentage + "%"))))
            })))
        }))))
    ...
    t.default = ie;
    var se = H.default.div(o, V.default.media.fourth),
        de = H.default.div(a, V.default.media.fourth),
        ue = H.default.div(i, V.default.media.fourth),
        ce = H.default.div(l),
        fe = H.default.div(s),
        pe = H.default.div(d, V.default.color.front2),
        he = H.default.div(u),
        me = H.default.span(c, V.default.color.black),
        ve = H.default.span(f, V.default.color.black),
        be = H.default.div(p),
        ge = H.default.div(h, V.default.media.fourth),
        we = H.default.div(l),
        ye = H.default.div(m, V.default.media.third),
        xe = H.default.div(v, V.default.media.third),
        _e = H.default.div(b, V.default.color.black, V.default.media.third),
        Ee = H.default.div(g, V.default.color.grey1, V.default.media.third),
        ke = H.default.div(w, V.default.media.third),
        Ce = H.default.div(y, V.default.color.black, V.default.media.third),
        Oe = H.default.div(x, V.default.color.grey1, V.default.media.third),
        Pe = H.default.g(_, V.default.color.front3),
        Se = H.default.div(E),
        Te = H.default.div(k, V.default.color.background1, V.default.color.background1, V.default.media.third, V.default.media.fourth),
        je = H.default.div(C),
        Fe = H.default.div(O, V.default.media.third),
        Ae = H.default.div(P, V.default.media.third),
        Re = H.default.div(S, V.default.media.third, V.default.media.fourth),
        ze = H.default.div(T, V.default.color.front3),
        Me = H.default.div(j, V.default.color.front3, V.default.media.third, V.default.color.grey1),
        Ie = H.default.div(F, V.default.color.grey1, V.default.media.third, V.default.media.fourth),
        Ne = H.default.div(A, V.default.color.grey1, V.default.media.third),
        Le = H.default.div(R, V.default.media.third),
        Be = H.default.div(z, function(e) {
            return e.percentage + "%"
        }, function(e) {
            return e.color
        }, function(e) {
        ...
        De = H.default.span(M, function(e) {
            return e.color
        }),
        We = H.default.div(I, V.default.media.fourth),
        Ue = H.default.div(N, V.default.media.third),
        Ke = H.default.div(L),
        He = H.default.div(B),
        Ge = H.default.div(D, V.default.color.black),
        Ye = H.default.div(W, V.default.color.front3)
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    function y(e) {
        ...
        return a.default.createElement(p.RightContainerPadding, null, a.default.createElement(p.RightHeader, null, a.default.createElement(u.default, {
            ...
            clear: "both"
        })), a.default.createElement(p.RightContent, null, a.default.createElement(u.default, null, a.default.createElement(u.default, null, a.default.createElement(f.default, null, "Currencies")), a.default.createElement(b.FormField, null, a.default.createElement(b.FormFieldLeft, null, a.default.createElement(m.Label, null, "Fiat currency")), a.default.createElement(b.FormFieldRight, null, a.default.createElement(h.default, {
            width: "100%",
            onChange: o
        }, n.map(function(e) {
        ...
        }))))), a.default.createElement(u.default, null, a.default.createElement(u.default, null, a.default.createElement(f.default, null, "Session")), a.default.createElement(b.FormField, null, a.default.createElement(b.FormFieldLeft, null, a.default.createElement(m.Label, null, "Network"), a.default.createElement(m.SubLabel, null, "Being on testnet you will use Coinfy within the test networks.")), a.default.createElement(b.FormFieldRight, null, a.default.createElement(h.default, {
            width: "100%",
            onChange: l
        }, a.default.createElement("option", {
            value: i.MAINNET,
        ...
        }, "Testnet")))), a.default.createElement(b.FormField, null, a.default.createElement(v.default, {
            width: "100%",
            onClick: s
    ...
    function B(e) {
        ...
        return g.default.createElement(z.RightContainerPadding, null, g.default.createElement(z.RightHeader, null, g.default.createElement(T.default, {
            float: "left"
        }, g.default.createElement(F.default, null, "Add asset"), g.default.createElement(A.default, null, "Create or Import assets")), g.default.createElement(T.default, {
            clear: "both"
            ...
            invalid: 0 === t.length,
            width: "100%"
        })), g.default.createElement(W, null, t.map(function(e) {
            return g.default.createElement(U, null, g.default.createElement(K, {
            ...
            }), g.default.createElement(H, null, g.default.createElement(Y, null, g.default.createElement(O.Show, {
                if: !0 === e.deletable
    ...
    var D = w.default.div(o),
        W = w.default.div(a),
        U = w.default.div(i, _.default.media.fifth),
        K = w.default.div(l, function(e) {
            return e.opacity
        }),
        H = w.default.div(s),
        ...
        q = w.default.div(m),
        $ = w.default.button(v, _.default.color.background1, _.default.color.front3, _.default.color.background4, _.default.color.background4)
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    function G(e) {
        ...
        return E.default.createElement(A.RightContainerPadding, null, E.default.createElement(A.RightHeader, null, E.default.createElement(L.default, null, E.default.createElement("img", {
            ...
            onClick: d
        }, "New")))) : E.default.createElement(W.default, null)))
    }
    t.default = H;
    var Y = k.default.div(o, O.default.media.second, O.default.media.third),
        ...
        oe = k.default.div(v),
        ae = k.default.div(b, O.default.color.background2),
        ie = k.default.div(g),
    ...
    function D(e) {
        ...
        var t = e.step,
            ...
            b = e.onClear,
            g = e.onCreate;
        return h.default.createElement("div", null, h.default.createElement(W, null, h.default.createElement(T.Wizard, null, [0, 1, 2].map(function(e) {
            return e < t ? h.default.createElement(T.WizardItem, {
                status: "3"
            }, "✓") : h.default.createElement(T.WizardItem, {
                status: e > t ? 1 : 2
            }, e + 1)
        }))), h.default.createElement(U, null, "Step ", h.default.createElement("span", null, t + 1), " of 3"), h.default.createElement(K, null, h.default.createElement(I.default, {
            active: t
        }, h.default.createElement(H, null, h.default.createElement(G, null, "Create Your Password"), h.default.createElement(Y, null, "Coinfy will protect your asset with a password. You need to remember your password as there is no way it can be recovered. This password protects your cryptocurrency if someone else tries to access your computer or mobile device."), h.default.createElement(V, null, h.default.createElement(F.FormField, null, h.default.createElement(R.default, {
            placeholder: "Password",
            ...
            disabled: !s,
            onClick: p
        }, "Next"))))), h.default.createElement(H, null, h.default.createElement(G, null, "Write Down or Print Your Recovery Phrase"), h.default.createElement(Y, null, "Write or print your recovery phrase and store it securely offline.", " ", h.default.createElement("strong", null, h.default.createElement("span", null, "Do not share it with anyone.")), " ", "Your recovery phrase allows you to recover your asset in case of loss or damage.", h.default.createElement("strong", null, " ", h.default.createElement("span", null, "Without it, you will not be able to access your cryptocurrency if something goes wrong.")), " ", "Make two copies of your recovery phrase and store them in separate physical locations. Please note, your recovery phrase is case sensitive and each word must be written in the correct order."), h.default.createElement(V, null, h.default.createElement(j.default, null, h.default.createElement(J, null, o.join(" ")), h.default.createElement(j.default, {
            position: "relative",
            top: "-20px"
            ...
            width: "100%",
            onClick: p
        }, "Next"))))), h.default.createElement(H, null, h.default.createElement(G, null, "Verify Your Recovery Phrase"), h.default.createElement(V, null, h.default.createElement(j.default, null, h.default.createElement(J, {
            error: l
    ...
    t.default = B;
    var W = m.default.div(o, b.default.media.fourth),
        U = m.default.div(a, b.default.media.fourth),
        K = m.default.div(i),
        H = m.default.div(l),
        G = m.default.div(s, b.default.color.background2, b.default.media.fourth),
        Y = m.default.div(d, b.default.color.front3, b.default.color.red3, b.default.media.fourth),
        V = m.default.div(u),
        J = m.default.div(c, function(e) {
            return e.error ? b.default.color.red3 : "black"
        }, function(e) {
            return e.error ? b.default.color.red3 : "transparent"
        }, function(e) {
            return e.error ? "shake 0.82s cubic-bezier(.36,.07,.19,.97) both" : "unset"
        }, b.default.media.fourth),
        X = m.default.div(f)
}, , function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    function C(e) {
        ...
        return a.default.createElement(f.RightContainerPadding, null, a.default.createElement(f.RightHeader, null, a.default.createElement(v.default, null, a.default.createElement("img", {
            src: l.logo
        })), a.default.createElement(p.default, {
            float: "left"
            ...
            clear: "both"
        })), a.default.createElement(f.RightContent, null, a.default.createElement(p.default, null, a.default.createElement("form", null, a.default.createElement(b.FormField, null, a.default.createElement(b.FormFieldLeft, null, a.default.createElement(m.Label, null, "I have my"), a.default.createElement(m.SubLabel, null, "Select the option you prefer to import.")), a.default.createElement(b.FormFieldRight, null, a.default.createElement(h.default, {
            width: "100%",
            onChange: n
        }, a.default.createElement("option", {
            value: E.seed,
    ...
    function C(e) {
        ...
        return a.default.createElement(f.RightContainerPadding, null, a.default.createElement(f.RightHeader, null, a.default.createElement(v.default, null, a.default.createElement("img", {
            ...
            clear: "both"
        })), a.default.createElement(f.RightContent, null, a.default.createElement("form", null, a.default.createElement(b.FormField, null, a.default.createElement(b.FormFieldLeft, null, a.default.createElement(m.Label, null, "I have my"), a.default.createElement(m.SubLabel, null, "Select the option you prefer to import.")), a.default.createElement(b.FormFieldRight, null, a.default.createElement(h.default, {
            width: "100%",
            onChange: n
        }, a.default.createElement("option", {
            value: E.seed,
    ...
    t.default = v;
    var b = u.default.div(l, c.default.color.background1, function(e) {
    ...
    function O(e) {
        ...
        return a.default.createElement(p.RightContainerPadding, null, a.default.createElement(p.RightHeader, null, a.default.createElement(b.default, null, a.default.createElement("img", {
            src: n.logo
            ...
            clear: "both"
        })), a.default.createElement(p.RightContent, null, a.default.createElement("form", null, a.default.createElement(g.FormField, null, a.default.createElement(g.FormFieldLeft, null, a.default.createElement(v.Label, null, "I have my"), a.default.createElement(v.SubLabel, null, "Select the option you prefer to import.")), a.default.createElement(g.FormFieldRight, null, a.default.createElement(m.default, {
            width: "100%",
            onChange: r
        }, a.default.createElement("option", {
            value: k.seed,
    ...
    t.Menu = function(e) {
        ...
        return function(e, t) {
            ...
            value: function() {
                ...
                return u.default.createElement("div", null, u.default.createElement(v, null, u.default.createElement(p.default, {
                    onChange: this.onChange
                }, n)), u.default.createElement(b, null, t))
            }
        }]), t
    }();
    var v = c.default.div(o, f.default.media.second),
        b = t.MenuContent = c.default.div(a, f.default.color.background1, f.default.media.second);
    ...
    var S = function(e) {
        ...
        return function(e, t) {
            ...
            value: function() {
                ...
                this.asset_id = t, this.changedLabel = !1, this.asset = (0, h.getAsset)(this.asset_id), this.Coin = v.Coins[this.asset.symbol], this.observer = (0, p.createObserver)(function(t) {
            ...
            value: function() {
                return c.default.createElement(T, {
                    ...
                    logo: v.Coins[this.asset.symbol].logo,
    ...
    function T(e) {
        ...
        return c.default.createElement(E.RightHeader, null, c.default.createElement(j, {
            onClick: function() {
                return u(b.routes.assetSettings)
            }
            ...
            onClick: function() {
                return u(b.routes.assetAddresses)
            }
    ...
    var z = function(e) {
        ...
        return function(e, t) {
            ...
            value: function() {
                ...
                }), this.observerPath.observe(v.default.location, "pathname"), this.refAddress = this.refAddress.bind(this), this.rescanOrLoad = this.rescanOrLoad.bind(this), this.onCopy = this.onCopy.bind(this), this.onPrint = this.onPrint.bind(this), this.observeAll()
            }
        }, {
            key: "componentWillUnmount",
            value: function() {
            ...
            value: function() {
                ...
                t !== this.asset_id && (this.asset_id = t, this.asset = (0, b.getAsset)(this.asset_id), this.Coin = f.Coins[this.asset.symbol], this.observer = (0, d.createObserver)(function(t) {
                    e.forceUpdate()
            ...
            value: function() {
                ...
                this.asset.summary.fetching = !0, this.Coin.fetchTxs((0, b.getAddresses)(t), n).then(function(t) {
    ...
    t.Transactions = m.default.div(r), t.Transaction = m.default.div(o, v.default.color.front3, v.default.color.background1), t.TransactionInner = m.default.div(a), t.TransactionDate = m.default.div(i), t.TransactionIco = m.default.div(l, function(e) {
        return e.color
    }), t.TransactionData = m.default.div(s), t.TransactionLabel = m.default.div(d, v.default.color.black, v.default.media.fourth), t.TransactionAmount = m.default.div(u, v.default.media.fourth), t.TransactionDetail = m.default.div(c, function(e) {
        return e.visible ? "45px" : 0
    }), t.TransactionDetailItem = m.default.div(f), t.TransactionDetailItemLabel = m.default.div(p, v.default.color.front2), t.TransactionDetailItemValue = m.default.div(h)
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    function T(e) {
        ...
        return f.default.createElement(_.default, null, f.default.createElement(j, null, r.map(function(e) {
            ...
            return f.default.createElement(F, {
                selected: r
            }, f.default.createElement(A, null, f.default.createElement(b.Show, {
                if: !t.multiaddress
    ...
    function C(e) {
        ...
        }))))), a.default.createElement(w.FormField, null, a.default.createElement(w.FormFieldLeft, null, a.default.createElement(y.Label, null, "Password"), a.default.createElement(y.SubLabel, null, "Password of this wallet.")), a.default.createElement(w.FormFieldRight, null, a.default.createElement(b.default, {
            width: "100%",
            value: l,
            onChange: c,
            type: "password",
        ...
        return function(e, t) {
            ...
            value: function(e) {
                ...
                var t = (0, i.collect)(),
                    ...
                    v = m ? o.decryptSeed(d, r.seed, p) : o.decryptPrivateKey(a, r.private_key, p);
                if (v) {
                    r.label || r.address;
                    m ? (0, c.setSeed)(n, v, h) : (0, c.setPrivateKey)(n, v, h), (0, c.addNotification)("You have changed the password of this asset", s.OK), (0, c.setHref)(l.routes.asset({
                        asset_id: n
                    }))
    ...
    function C(e) {
        ...
        return a.default.createElement("div", null, a.default.createElement(l.Show, {
            ...
            invalid: d
        }))), a.default.createElement(y.FormField, null, a.default.createElement(y.FormFieldLeft, null, a.default.createElement(w.Label, null, "Password"), a.default.createElement(v.default, null, "Make sure that you remember this. This password can't be restored because we don't store it. For security reasons you will be asked often for this password."), a.default.createElement(w.SubLabel, null, "This password encrypts your private key.")), a.default.createElement(y.FormFieldRight, null, a.default.createElement(g.default, {
            minlength: s.minpassword,
            value: r,
            onChange: E,
            width: "100%",
            type: "password"
        }))), a.default.createElement(y.FormField, null, a.default.createElement(y.FormFieldLeft, null, a.default.createElement(w.Label, null, "Repeat Password")), a.default.createElement(y.FormFieldRight, null, a.default.createElement(b.default, {
            minlength: s.minpassword,
            error: "Passwords do not match",
            invalid: u,
            value: o,
    ...
    var j = function(e) {
        ...
        return function(e, t) {
            ...
            value: function() {
                ...
                this.observer = (0, d.createObserver)(function(t) {
                    return e.forceUpdate()
                }), this.observer.observe(v.default.view), this.logo_default = (0, u.ASSET_LOGO)("ERC20"), v.default.view = {
                    fetching: !1,
                    contract_address: "",
                    symbol: "",
                    name: "",
            ...
            value: function(e) {
                var t = this,
                    n = e.trim();
                if (v.default.view.contract_address !== n) {
                    var r = (0, d.collect)();
                    if (v.default.view.contract_address = n, (0, h.isAddress)(n)) {
                        var o = 0;
                        v.default.view.contract_address_error = "", v.default.view.fetching = !0, (0, m.getSymbolContract)(n).then(function(e) {
                            ...
                            if (null !== e) {
                                var r = (0, d.collect)();
                                v.default.view.fetching = !1, t.onChangeDecimals(e), r.emit()
                            } else if (2 === o) return (0, m.getSupplyContract)(n)
                        }).then(function(e) {
                            return null !== e || (0, m.isErc20Contract)(n)
                        }).then(function(e) {
                            v.default.view.fetching = !1, e || (v.default.view.contract_address_error = "Seems like this address is not an ERC20 contract.")
                        })
                    } else v.default.view.contract_address_error = "Invalid address";
                    r.emit()
                }
            }
        }, {
            ...
            value: function(e) {
                var t = e.trim().toUpperCase(),
                    n = (0, d.collect)();
                v.default.view.symbol = t, v.default.view.symbol_error = p.Coins.hasOwnProperty(t) ? "Duplicated symbol." : "", t.length > 2 && !p.Coins.hasOwnProperty(t) && this.onChangeLogo((0, u.ASSET_LOGO)(t), !1), n.emit()
            }
        }, {
            key: "onChangeName",
            value: function(e) {
                v.default.view.name = e.trim()
            }
        }, {
            ...
            value: function(e) {
                var t = Number(e),
                    n = (0, d.collect)();
                v.default.view.coin_decimals = e, v.default.view.coin_decimals_error = isNaN(t) ? "Invalid number" : "", n.emit()
            }
        }, {
            key: "onChangeLogo",
            value: function(e) {
                ...
                if ((e = e.trim()) !== v.default.view.logo) {
                    var r = new Image;
                    if (r.crossOrigin = "Anonymous", r.src = e, r.onload = function() {
                            var n = (0, d.collect)();
                            v.default.view.logo = e, v.default.view.logo_visible = e, t.onChangeColor((0, f.rgbToHex)((0, f.getAverageColor)(r))), n.emit()
                        }, r.onerror = function() {
                            n && (v.default.view.logo_visible = t.logo_default)
                        }, n) {
                        var o = (0, d.collect)();
                        v.default.view.logo = e, v.default.view.logo_visible = "/static/image/loading.gif", o.emit()
                    }
                }
            }
        }, {
            ...
            value: function(e) {
                var t = e.trim(),
                    n = (0, d.collect)();
                v.default.view.color = e.toUpperCase(), v.default.view.color_error = /^#[0-9a-fA-F]{3,6}$/.test(t) ? "" : "Invalid color", n.emit()
            }
        }, {
            key: "onSubmit",
            value: function(e) {
                e.preventDefault();
                var t = v.default.view.symbol;
                (0, b.createCustomERC20)({
                    symbol: t,
                    name: v.default.view.name,
                    color: v.default.view.color,
                    contract_address: v.default.view.contract_address,
                    coin_decimals: Number(v.default.view.coin_decimals),
                    labels: t.toLowerCase() + " ethereum token erc20 ecr20 custom",
                    logo: v.default.view.logo_visible,
                    networks_availables: [v.default.network]
                }), (0, b.addNotification)("You have created " + t + " as Custom ERC20 token", u.OK), (0, b.setHref)(c.routes.add({
                    filter: t
                }))
            }
        }, {
            ...
            value: function() {
                return l.default.createElement(F, {
                    fetching: v.default.view.fetching,
                    contract_address: v.default.view.contract_address,
                    symbol: v.default.view.symbol,
                    name: v.default.view.name,
                    coin_decimals: v.default.view.coin_decimals,
                    logo: v.default.view.logo,
                    logo_visible: v.default.view.logo_visible,
                    color: v.default.view.color,
                    contract_address_error: v.default.view.contract_address_error,
                    symbol_error: v.default.view.symbol_error,
                    name_error: v.default.view.name_error,
                    coin_decimals_error: v.default.view.coin_decimals_error,
                    color_error: v.default.view.color_error,
                    isValidForm: this.isValidForm,
                    onChangeAddress: this.onChangeAddress,
            ...
            key: "isValidForm",
            get: function() {
                return !1 === v.default.view.fetching && v.default.view.contract_address.length > 0 && "" === v.default.view.contract_address_error && v.default.view.symbol.length > 0 && "" === v.default.view.symbol_error && v.default.view.name.length > 0 && "" === v.default.view.name_error && v.default.view.coin_decimals > -1 && "" === v.default.view.coin_decimals_error && v.default.view.color.length > 0 && "" === v.default.view.color_error
            }
        }]), t
    }();
